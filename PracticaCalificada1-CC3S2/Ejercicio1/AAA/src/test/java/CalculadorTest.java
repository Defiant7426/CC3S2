...
class CalculadorTest {
    ...
    @Test
    void testSum_SumByZero_ShouldReturnSameNumber(){
        //Arrange
        Calculador calculador = new Calculador();
        int numeroA = 5;
        int numeroB = 0;
    ...
    @Test
    void testRest_PositiveNumbers_ShouldreturnCorrectRest(){
        // Arrange
        Calculador calculador = new Calculador();
        int numeroA = 10;
        int numeroB = 3;
    ...
    @Test
    void testRest_NegativeNumbers_ShouldReturnCorrestRest(){
        // Arrange
        Calculador calculador = new Calculador();
        int numeroA = -4;
        int numeroB = -3;
    ...
    @Test
    void testRest_NoNumberZeroRestByZero_ShouldReturnSameNumber(){
        //Arrange
        Calculador calculador = new Calculador();
        int numeroA = 5;
        int numeroB = 0;
    ...
    @Test
    void testRest_ZeroRestByNoNumberZeroPositive_ShouldReturnNegativeNumber(){
        //Arrange
        Calculador calculador = new Calculador();
        int numeroA = 0;
        int numeroB = 5;
    ...
    @Test
    void testRest_ZeroRestByNoNumberZeroNegative_ShouldReturnPositiveNumber(){
        //Arrange
        Calculador calculador = new Calculador();
        int numeroA = 0;
        int numeroB = -5;
    ...
    @Test
    void testMultiplication_PositiveNumbers_ShouldreturnCorrectMultiplication(){
        // Arrange
        Calculador calculador = new Calculador();
        int numeroA = 4;
        int numeroB = 5;
    ...
    @Test
    void testMultiplication_NegativeNumbers_ShouldreturnCorrectMultiplication(){
        // Arrange
        Calculador calculador = new Calculador();
        int numeroA = -6;
        int numeroB = -3;
    ...
    @Test
    void testMultiplication_ByZero_ShouldreturnZero(){
        //Arrange
        Calculador calculador = new Calculador();
        int numeroA = 5;
        int numeroB = 0;
    ...
    @Test
    void testMultiplicacion_ByTwoNumbersOppositeSign_ShouldReturnNegativeNumber(){
        //Arrange
        Calculador calculador = new Calculador();
        int numeroA = 4;
        int numeroB = -2;
    ...
    @Test
    void testDivision_DivideByNoZero_ShouldreturnCorrectDivision(){
        // Arrange
        Calculador calculador = new Calculador();
        int numeroA = 18;
        int numeroB = 3;
    ...
    @Test
    void testDivision_DivideByZero_ShouldThrowArithmeticException(){
        //Arrange
        Calculador calculador = new Calculador();
        int numeroA = 10;
        int numeroB = 0;
    ...
    @Test
    void testDivision_DivideZeroByNoZero_ShouldReturnZero(){
        //Arrange
        Calculador calculador = new Calculador();
    ...
    @Test
    void testDivision_NegativeNumbers_ShouldReturnCorrectResult(){
        //Arrange
        Calculador calculador = new Calculador();
        int numeroA = -12;
        int numeroB = -3;
    ...
    @Test
    void testDivision_ByTwoNumberOppositeSign_ShouldReturnCorrectResult(){
        //Arrange
        Calculador calculador = new Calculador();
        int numeroA = -12;
        int numeroB = 4;
